...
namespace orion
{
    ...
    enum class BindGroupLayoutHandle : render_device_handle_t { Invalid = invalid_device_handle };
    ...
    enum class BindGroupHandle : render_device_handle_t { Invalid = invalid_device_handle };
